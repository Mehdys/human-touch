        ...
        <div className="max-w-sm mx-auto w-full">
          ...
          >
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-white text-gray-700 border border-border font-medium py-4 px-8 rounded-xl hover:bg-gray-50 transition-all active:scale-[0.98] shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
            >
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Email"
                  className={`w-full pl-12 pr-4 py-4 rounded-xl border bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all ${errors.email ? "border-destructive" : "border-border focus:border-primary"
                    }`}
                />
              </div>
              {errors.email && (
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-4 rounded-xl border bg-card text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 transition-all ${errors.password ? "border-destructive" : "border-border focus:border-primary"
                    }`}
                />
                <button
                  type="button"
